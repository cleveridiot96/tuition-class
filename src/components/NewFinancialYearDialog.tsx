...
import { OpeningBalance } from '@/services/types';
...
const NewFinancialYearDialog = ({ isOpen, onClose, onYearCreated }: NewFinancialYearDialogProps) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      const newYear = generateNextFinancialYear();
        ...
        if (previousYear) {
          ...
          if (closingBalances) {
            ...
            const openingBalances: OpeningBalance = {
              ...
              cash: closingBalances.cash,
              bank: closingBalances.bank,
              stock: closingBalances.stock,
              parties: closingBalances.parties
            };
