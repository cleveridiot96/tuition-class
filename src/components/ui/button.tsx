...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:-translate-y-0.5 active:translate-y-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-ag-green to-ag-green-dark text-primary-foreground hover:shadow-md shadow-sm",
        destructive:
          "bg-gradient-to-r from-red-500 to-red-700 text-destructive-foreground hover:shadow-md shadow-sm",
        outline:
          "border-2 border-input bg-background hover:bg-accent hover:text-accent-foreground hover:border-ag-green-light",
        secondary:
          "bg-gradient-to-r from-ag-brown-light to-ag-brown text-secondary-foreground hover:shadow-md shadow-sm",
