...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center justify-center py-1",
      className
    )}
    {...props}
  >
...
// Create a searchable select content component
      ...
      >
        ...
        {searchable && (
          <div className="px-2 py-2 sticky top-0 bg-popover border-b">
            <div className="flex items-center gap-2 rounded-sm px-2 border border-input">
